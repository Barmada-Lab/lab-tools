...
def parse_args():
    ...
    parser.add_argument("--no-gedi", help="[NOT YET FUNCTIONAL] don't use rfp gedi", default=True, action='store_false')
...
def run():
    args = parse_args()
    core.process(args.experiment_path, args.scratch_path, args.save_masks, args.single_cell, args.no_gedi, args.avg_reg, args.cpus)
