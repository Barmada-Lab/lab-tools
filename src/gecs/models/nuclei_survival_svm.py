...
from skimage import filters, exposure, segmentation  # type: ignore
...
def evaluate(arr, seg_model, pipe):
    ...
    objects, _ = seg_model.predict_instances(clahed_float)
