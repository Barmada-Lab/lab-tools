...
def run(path: pl.Path, scratch: pl.Path, use_stored: bool = True, use_slurm: bool = False):
    ...
    sample = experiment.sel(well=["B02","B03","B04","B05","B06","B07","B08","B09","B10","B11", "C02","C03","C04","C05","C06","C07","C08","C09","C10","C11"], channel="GFP")
    # survival_marker = sample.sel(channel="GFP")
    logmax = logmax_filter(sample)
